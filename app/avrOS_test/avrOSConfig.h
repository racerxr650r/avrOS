...
// Precision Timer (RTC + TCB cascade) ----------------------------------------
#define TMR_TCB				SYS_TIMER_TCB1			// Cascade high-word timer; must differ from SYS_TICK_TIMER
#define TMR_RTC_CLK			RTC_CLKSEL_OSC32K_gc	// RTC clock source
													// RTC_CLKSEL_OSC32K_gc = internal 32.768 kHz oscillator
													// RTC_CLKSEL_OSC1K_gc = internal 1.024 kHz oscillator
													// RTC_CLKSEL_XOSC32K_gc = external 32.768 kHz crystal
													// RTC_CLKSEL_EXTCLK_gc = external clock
#define TMR_RTC_PRESCALER	RTC_PRESCALER_DIV32_gc	// 32768 / 32 = 1024 ticks/sec (use DIV1 with OSC1K)
#define TMR_EVT_CHANNEL		EVT_CHANNEL0			// EVSYS channel routing RTC overflow to the TCB (EVT_CHANNEL0..7)
...
#define UTS_DATA_BITS CLI_DATA_BITS   // Report UART data bits
#define UTS_STOP_BITS CLI_STOP_BITS   // Report UART stop bits
...
#define TMR_CLI     // Precision timer commands
...
#undef TMR_CLI		// Precision timer commands
// Enabling stats also includes string names used by associated CLI commands
